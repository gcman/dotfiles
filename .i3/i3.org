...
mode "$mode_monitors" {
  bindsym 0 exec --no-startup-id "xrandr --output DP-1 DP1 --off", mode "default"
...
#+BEGIN_SRC conf
bindsym XF86MonBrightnessDown exec change-brightness -U 5
bindsym XF86MonBrightnessUp exec change-brightness -A 5
#+END_SRC
** Workspaces
...
assign [class="^mpv$"] → output DP-1 DP1
assign [class="^Inkscape$"] → output DP-1 DP1
#+END_SRC
